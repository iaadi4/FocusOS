...
export function Sidebar() {
  ...
  return (
    <div className="w-[400px] h-[600px] p-0 bg-background/95 backdrop-blur-2xl text-white flex flex-col font-sans selection:bg-primary/30 overflow-hidden relative animate-scale-in">
